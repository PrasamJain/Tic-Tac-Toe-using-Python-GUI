...
class TIC_TAC_TOE_AI:
    ...
    def decorating(self):# Basic Set-up
        Label(self.make_canvas, text="Zerox Tic Tac Toe", bg="#141414", fg="#00FF00", font=("Lato", 25, "bold")).place(x=90, y=10)
        ...
        self.machine_first_control = Button(self.make_canvas, text="Machine First", font=("Arial", 15, "bold", "italic"), bg="#262626", activebackground="#262626", fg="#9d9dff", relief=RAISED, bd=3, command=lambda: self.control_give("machine_first"))
        self.machine_first_control.place(x=25, y=380)

        self.human_first_control = Button(self.make_canvas, text="Human First", font=("Arial", 15, "bold", "italic"), bg="#262626", activebackground="#262626", fg="#9d9dff", relief=RAISED, bd=3, command=self.control_give)
        self.human_first_control.place(x=280, y=380)
